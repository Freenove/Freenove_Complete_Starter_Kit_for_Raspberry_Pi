...
class Freenove_SPI_LedPixel(object):
    ...
    def write_ws2812_numpy8(self):
        ...
        for ibit in range(8):                          #Convert each bit of data to the data that the spi will send
            ...
            #tx[7-ibit::8]=((d>>ibit)&1)*0x7C + 0x80   #T0H=1,T0L=7, T1H=6,T1L=2   #0b11111100 mean T1(0.9375us),  0b10000000 mean T0(0.15625us)
...
if __name__ == '__main__':
    ...
    #led = Freenove_SPI_LedPixel(8, 255, 'GRB', 1)   # Use MOSI for /dev/spidev1 to drive the lights灯
